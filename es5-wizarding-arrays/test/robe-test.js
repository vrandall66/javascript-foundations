...
describe('A wizard\'s robe', () => {
  ...
  it('has a lot of pockets and initially all are empty', function () {
    var robe = new Robe();
  ...
  it('can put things in the pockets', function () {
    var robe = new Robe();
  ...
  it('can not have two things in one pocket', function () {
    var robe = new Robe();
  ...
  it('can fill up all the pockets', function () {
    var robe = new Robe();
  ...
  it('can retrieve things from pockets by name', function () {
    var robe = new Robe();
    robe.addToPocket('magic wand');
  ...
  it('can empty all pockets', function () {
    var robe = new Robe();
    var cats = ['1 cat', '2 cat', '3 cat', '4 cat', '5 cat', '6 cat', '7 cat', '8 cat', '9 cat', '10 cat'];
