...
describe('A wizard\'s potions cabinet and potions', () => {
  ...
  describe('A potion', function () {
    ...
    it('indicates rareness by integers, 0 being not rare', function () {
      var potion = new Potion('truth serum', 5);

      assert.equal(potion.rareness, 5);
    });

    it('is not rare by default', function () {
      var potion = new Potion('truth serum');

      assert.equal(potion.rareness, 0);
    });

    it('indicates whether or not it is rare', function () {
  ...
  describe('A potion cabinet', function () {
    ...
    it('is empty if nothing is put in it', function () {
      var cabinet = new Cabinet();
      assert.equal(cabinet.isEmpty(), true);
    });

    it('is possible to put things in the cabinet', function () {
      var cabinet = new Cabinet();
      var potion = new Potion('truth serum', 12);
    ...
    it('is possible to take things out of the cabinet', function () {
      var cabinet = new Cabinet();
    ...
    it('is possible to take potions out by name', function () {
      var cabinet = new Cabinet();
    ...
    it('is possible to have duplicate potions in the cabinet', function () {
      var cabinet = new Cabinet();
    ...
    it('when removing a potion with a duplicate, only one is removed', function () {
      var cabinet = new Cabinet();
