...
describe('Hobbit', () => {
  ...
  it('should instantiate our good friend, Hobbit', () => {
  ...
  it('should have an unadventurous disposition', () => {
  ...
  it('should have gained 1 year after every birthday', () => {
    const hobbit = new Hobbit('Meriadoc');
    assert.equal(hobbit.age, 0);
  ...
  it('should have the ring if its name is Frodo', () => {
